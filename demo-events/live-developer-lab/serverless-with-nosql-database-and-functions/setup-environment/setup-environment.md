...
1. Execute the following in your Cloud Shell.
    ...
    curl -L https://github.com/oracle/nosql-examples/raw/master/zips/serverless-with-nosql-database.zip -o serverless-with-nosql-database.zip
    unzip serverless-with-nosql-database.zip
    rm -f serverless-with-nosql-database.zip
