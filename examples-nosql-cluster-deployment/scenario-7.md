# Scenario 7 - multiple zones (2 primary/1 secondary) + arbiters
...
3, but this isnt always possible.   This example shows using a replication factor of 2 in both the primary and secondary zones.  Secondary zones are read 
